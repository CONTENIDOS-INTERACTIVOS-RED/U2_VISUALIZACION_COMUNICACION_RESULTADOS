        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 2 aborda la visualización y comunicación de resultados en entornos organizacionales mediante el uso de data storytelling. Enseña a transformar datos en narrativas visuales estratégicas para generar decisiones efectivas. Se exploran fundamentos de storytelling con datos, técnicas de presentación de insights con KPIs, ROI y OKR, análisis interactivo mediante herramientas BI, y el diseño de dashboards empresariales. Además, se incluyen fórmulas clave, ejemplos sectoriales y criterios de evaluación comunicativa. El enfoque integra tecnología, comunicación y acción, formando profesionales capaces de generar impacto real con visualizaciones claras y persuasivas.
